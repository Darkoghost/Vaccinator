...
namespace Vaccinator.Controllers
{
    public class PersonnesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,Sexe,DateDeNaissance,Status")] Personne personne)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,Sexe,DateDeNaissance,Status")] Personne personne)
        {
            if (id != personne.Id)
            {
                return NotFound();
